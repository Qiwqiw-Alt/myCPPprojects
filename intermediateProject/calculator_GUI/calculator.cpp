...
public:
    Calculator() : wxFrame(NULL, wxID_ANY, "My Calulator", wxPoint(50, 50), wxSize(420, 550)) {
        ...
        // delButton->SetSize(50, 430, 150, 50);
        // clrButton->SetSize(200, 430, 150, 50);

        auto* gridSizer = new wxGridSizer(4, 5, 10, 10);

        // for (auto & numberButton : numberButtons) {
        //     gridSizer->Add(numberButton, 0, wxEXPAND | wxALL, 5);
        // }
        //
        // for (auto & funcButton: funcButton) {
        //     gridSizer->Add(funcButton, 0, wxEXPAND | wxALL, 5);
        // }
        ...
        panel->SetPosition(wxPoint(50, 50));
    ...
    void Calculator::OnButtonClick(wxCommandEvent& event) {
        ...
        if (src == eqButton) {
            ...
            textField->SetValue(wxString::Format("%d", result));
            num1 = result;
            return;
        }
